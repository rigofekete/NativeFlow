...
// // BUFFER/BLIT FUNCTIONS NOT USED AT THE MOMENT BUT MIGHT COME IN HANDY
...
//             int frameY = MARGIN + 90;  // Align with top of listbox
...
//             int scaledWidth = (int)(CurrentFrame->Buffer.Width * (scale - 0.2));
//             int scaledHeight = (int)(CurrentFrame->Buffer.Height * (scale - 0.1));
